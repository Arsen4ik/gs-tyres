      ...
      <article className="bg-white">
        ...
        <div className="ph4 ph5-m ph6-l">
          ...
          <h1 className="fw6 f2 fl w-100 red black-60 mt0 mb3 avenir">
                ИНТЕРАВТО. КРОКУС ЭКСПО. ЗАЛ № 5
              </h1>
            <p className="db lh-copy black-70 serif fw1 mv0 f4 f3-m f2-l measure baskerville">
              17-я международная выставка автомобильной индустрии.
              <br />
               23 Августа 2022 — 26 Августа 2022 приглашаем Вас посетить наш стенд <br /> М 354,
              Павильон 2, Зал 5 <br /> Вашему вниманию будет представлена продукция
